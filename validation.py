...
def validate_age_inputs(age_inputs: dict[str, Any]) -> str | None:
...
def validate_financial_inputs(user_inputs: dict[str, Any]) -> str | None:
...
def validate_account_data(accounts: list) -> str | None:
